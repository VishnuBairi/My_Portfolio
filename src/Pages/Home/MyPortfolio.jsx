...
export default function MyPortfolio() {
    const redirectToWebsite = () => {
      window.open("https://www.github.com/VishnuBairi", "_blank", "noopener,noreferrer");
    };
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <button onClick={redirectToWebsite} className="btn btn-github">
            <svg
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <a className="text-sm portfolio--link" href=
                {item.link} target="_blank" rel="noopener noreferrer">View in Github
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
